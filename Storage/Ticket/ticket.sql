...
COPY country FROM '/var/lib/postgresql/initial_data/country.csv' DELIMITER ',' CSV HEADER;
COPY city FROM '/var/lib/postgresql/initial_data/city.csv' DELIMITER ',' CSV HEADER;
COPY airport FROM '/var/lib/postgresql/initial_data/airport.csv' DELIMITER ',' CSV HEADER;
COPY aircraft_type FROM '/var/lib/postgresql/initial_data/aircraft_type.csv' DELIMITER ',' CSV HEADER;
COPY aircraft_layout FROM '/var/lib/postgresql/initial_data/aircraft_layout.csv' DELIMITER ',' CSV HEADER;
COPY aircraft FROM '/var/lib/postgresql/initial_data/aircraft.csv' DELIMITER ',' CSV HEADER;
COPY flight FROM '/var/lib/postgresql/initial_data/flight.csv' DELIMITER ',' CSV HEADER;
